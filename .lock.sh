...
export XSECURELOCK_KEY_F4_COMMAND="playerctl previous"
export XSECURELOCK_KEY_F5_COMMAND="playerctl play-pause"
export XSECURELOCK_KEY_F6_COMMAND="playerctl next"
